          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-80 h-80 mx-auto relative">
                <div className="absolute inset-0 bg-gradient-to-br from-portfolio-primary to-portfolio-accent rounded-full p-1">
                  <div className="w-full h-full bg-gray-200 rounded-full flex items-center justify-center">
                    <User className="w-32 h-32 text-portfolio-neutral" />
                  </div>
                </div>
                {/* Floating elements */}
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-portfolio-secondary rounded-full flex items-center justify-center animate-pulse">
            ...
            <div className="space-y-6">
              <div className="portfolio-card p-8 rounded-xl">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-portfolio-primary/10 to-portfolio-accent/10 rounded-lg">
                  <h4 className="font-semibold text-portfolio-primary mb-2">Current Focus</h4>
